import { WrappedReader } from './reader-wrapper.js';
...
*/
export declare function downloadDbs(options?: {
    path: Path;
    dbList: GeoIpDbName[];
}): Promise<void>;
/**
...
*/
export declare function open<DbReaderInstance extends {}>(dbName: GeoIpDbName, readerInitializer: (path: Path) => DbReaderInstance | Promise<DbReaderInstance>, downloadDirPath?: Path): Promise<WrappedReader<DbReaderInstance>>;
